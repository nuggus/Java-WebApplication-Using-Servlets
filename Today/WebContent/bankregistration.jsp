...
document.bankform.disablebox.style.visibility="hidden";
...

  {
   ...
   var bcode=document.forms["bankform"]["bcode"].value;
...
else if(scontact=="" || scontact==null || isNaN(scontact) || scontact.length !=10)
...
<tr>
 ...
 <td>Bank Code<font color="red"><sub>*</sub></font></td>
 <td>
 <input type="text" size="20" maxlength="15" name="bcode"/></td>
